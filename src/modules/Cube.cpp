...
Cube::Cube() : position(glm::vec3(0.0, 0.0, 0.0)),
...
{
	genTex(diffuseMap, "./texture/container2.png");
	genTex(specularMap, "./texture/container2_specular.png");
}

void Cube::genTex(GLuint &map, const char *filename)
{
	int width, height;
...
void Cube::draw(GLSLProgram *shader, glm::mat4 view, glm::mat4 proj)
{
	shader->use();
